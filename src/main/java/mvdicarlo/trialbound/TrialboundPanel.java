...
import mvdicarlo.trialbound.ui.TrialsTabPanel;
import mvdicarlo.trialbound.ui.UnlocksTabPanel;
...
@Singleton
public class TrialboundPanel extends PluginPanel {
    ...
    @Inject
    public TrialboundPanel(TrialsTabPanel trialsTab, UnlocksTabPanel unlocksTab,
            SessionState sessionState, GroupStateService groupState, ObtainedSyncService obtainedSync,
            PartyService partyService, TrialboundConfig config) {
