...
@ConfigGroup(TrialboundPlugin.CONFIG_GROUP)
public interface TrialboundConfig extends Config {
    ...
    @ConfigItem(keyName = "enableTrialbound", name = "Character name", position = 1, description = "Enables Trialbound for the provided character name.", section = generalSection)
    default String enableTrialbound() {
        return "";
    }
