...
import mvdicarlo.trialbound.TrialboundPlugin;
import mvdicarlo.trialbound.SessionState;
import mvdicarlo.trialbound.TrialboundChat;
import mvdicarlo.trialbound.events.ObtainedSetChanged;
...
public class ObtainedSyncService {
    ...
    public ObtainedSyncService(Client client, ConfigManager configManager, EventBus eventBus,
            SessionState sessionState, TrialboundConfig config, TrialboundChat chat) {
        this.client = client;
    ...
    private void loadPersisted(String profileKey) {
        ...
        String csv = configManager.getRSProfileConfiguration(TrialboundPlugin.CONFIG_GROUP, KEY_OBTAINED);
        ...
        try {
            ...
            String count = configManager.getRSProfileConfiguration(TrialboundPlugin.CONFIG_GROUP, KEY_COUNT);
    ...
    private void persist() {
        ...
        configManager.setRSProfileConfiguration(TrialboundPlugin.CONFIG_GROUP, KEY_OBTAINED, csv);
        configManager.setRSProfileConfiguration(TrialboundPlugin.CONFIG_GROUP, KEY_COUNT, expectedCount);
        configManager.setRSProfileConfiguration(TrialboundPlugin.CONFIG_GROUP, KEY_SYNC_TIME, Instant.now().toString());
    }
